...
import csv
from my_module import dataset, alexnet_make, resnet_make, gradcam_make, rand_erase
import os
import torchvision
import glob
...
models_name = 'models_' + cnn_name + '_py'


net2_dict = './' + models_name + '/model_epoch_95.ckpt'
...
mask_img_save_dir = cnn_name + '_mask_img_save'
...
#     torch.save(net.module.state_dict(), './' + models_name +
...
for tvt in tvts:
    ...
    #   for k in range(5):#5 classes
        ...
        random_erasing = rand_erase.RandomErasing(probability = 0.5, mean=[0.4914, 0.4822, 0.4465], gd_th = -0.6, sl = 0.02, sh = 0.4, r1 = 0.3)
