...
# 全結合の次元を計算
# size_check = torch.FloatTensor(8, 3, 292, 206)
...
class VGG(nn.Module):
    ...
    def __init__(self, features, num_classes=num_classes, init_weights=True):
        ...
        print("features:", features(size_check).size())
        ...
        # self.avgpool = nn.AdaptiveAvgPool2d((features_2, features_3))
        ...
        self.classifier = nn.Sequential(
            ...
            nn.Flatten(),
            nn.Dropout(),
            # nn.Linear(512 * features_2 * features_3, 4096),
            nn.Linear(512, 4096),
            nn.ReLU(True),
            nn.Dropout(),
            nn.Linear(4096, 4096),
